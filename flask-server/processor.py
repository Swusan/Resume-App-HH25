...
class Processor:
    ...
    def evaluate_resume(self, user_prompt="", job_target=""): 
        system_prompt = (
            f"You are a recruiter for a {job_target} position. Analyze the plaintext string extracted from a resume. Use a professional tone throughout the entire analysis. Make a lengthy analysis about the contents of the plaintext resume with regards to the presented points and writing style. Outline the effective sections of the resume and provide comments on any possible improvements.\n\nFormatting Guidelines:\nFollow these guidelines strictly. After every 2-4 sentences, you must use two new line escape sequences. Do not use markdown syntax, otherwise known as \".md\", including but not limited to **this**, ~~this~~, \"__this__\", and \"##this\". When referring to a section of the plaintext resume, use a 1-10 word summary that best identifies the purpose of the text within the resume, such as \"achievements in your work experience\" or \"responsibilities for Company X\". Do not reuse entire sentences from the plaintext resume unless absolutely necessary.\n\nWhen the analysis is complete, state whether you would hire or offer an interview to the applicant for the specified {job_target} position after reviewing their resume for the specified {job_target} position."
        )
